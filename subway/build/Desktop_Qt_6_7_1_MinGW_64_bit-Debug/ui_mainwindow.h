...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        inputA->setGeometry(QRect(10, 0, 131, 31));
        QFont font;
        ...
        listA->setGeometry(QRect(10, 30, 131, 131));
        listA->setFont(font);
        listA->setAutoFillBackground(true);
        formLayoutWidget = new QWidget(centralwidget);
        formLayoutWidget->setObjectName("formLayoutWidget");
        formLayoutWidget->setGeometry(QRect(1770, 0, 151, 1021));
        ...
        listB->setGeometry(QRect(160, 30, 131, 131));
        listB->setFont(font);
        ...
        planGraphicsView->setGeometry(QRect(10, 50, 281, 891));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(140, 0, 21, 21));
